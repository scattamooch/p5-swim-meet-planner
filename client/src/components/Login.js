    ...
    return (
        <div>
          <div className="login-container">
            ...
            <input className="login-input" type="text" placeholder="Username" onChange={handleUsernameChange}/>
            <input className="login-input" type="password" placeholder="Password" onChange={handlePasswordChange}/>
